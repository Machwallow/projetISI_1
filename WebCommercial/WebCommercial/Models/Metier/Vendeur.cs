...
namespace WebCommercial.Models.Metier
{
    public class Vendeur
    {
        ...
        private String nuVendeurChefEquipe;
        ...
        public String NuVendeurChefEquipe { get => nuVendeurChefEquipe; set => nuVendeurChefEquipe = value; }

        public Vendeur(String noVendeur, String nuVendeurChefEquipe, string nomVendeur, string preVendeur, string dateEmb, string villeVendeur, double salVendeur, double commission)
        {
